...
/**
 * Buddy token smart contract.
 */
contract BuddyToken is AbstractToken {
  /**
  ...
  /**
   * Create new Buddy token smart contract, with given number of tokens issued
   * and given to msg.sender.
   *
   * @param _tokenCount number of tokens to issue and give to msg.sender
   */
  function BuddyToken (uint256 _tokenCount) public {
